    ...
    <section className='flex bg-[#F2F4F3] flex-col justify-center gap-[30px] py-[30px] px-[60px] shadow-md'>
        ...
        <div className='flex flex-wrap justify-between'>
            <div className='flex gap-[10px] flex-col'>
                ...
                <p className='w-[auto] md:w-[300px]'>This is a demo store by Clean Canvas. All images and video content courtesy of Shutterstock and Pixels, and are not for re-use on other stores.</p>
            ...
            <div className='w-[300px]'>
                <ul className='list-none text-md flex flex-col gap-[10px]'>
                    ...
                    <li className=''>Join our community to get exclusive offers, original recipes, event invites and more...</li>
                </ul>
                <div className='flex h-[40px] mt-[10px]'>
                    <input className='outline-none h-[100%] w-[70%] md:w-[100%] rounded-l-md px-[10px] py-[8px]' type="text" placeholder='Your email' />
